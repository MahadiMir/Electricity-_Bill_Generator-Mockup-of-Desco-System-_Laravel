...
<div class="page" id="top">
    ...
    <div class="page-section">
        <div class="container relative">
            ...
            <!-- Works Grid -->
            <ul class="works-grid work-grid-2 work-grid-gut clearfix font-alt hover-white hide-titles" id="work-grid">

                <!-- Work Item (Lightbox) -->
                <li class="work-item mix branding design">
                    <a href="{{route('customer.regpage')}}" class="work-ext-link">
                        <div class="work-img">
                            <img src="zend/assets/images/portfolio/reg.jpg" alt="Work" />
                        </div>
                        <div class="work-intro">
                            <h2 class="work-title">Register</h2>
                            <div class="work-descr">
                                If you are not a registered customer, then register yourself
                            </div>
                        </div>
                    </a>
                </li>
                ...
                <li class="work-item mix branding design">
                    <a href="{{route('bill.index')}}" class="work-ext-link">
                        <div class="work-img">
                            <img class="work-img" src="zend/assets/images/portfolio/issue.png" alt="Work" />
                        </div>
                        <div class="work-intro">
                            <h2 class="work-title">Bill Issuance</h2>
                            <div class="work-descr">
                                Avail your bill
                            </div>
                        </div>
