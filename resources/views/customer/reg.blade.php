                    ...
                    <div class="tab-content tpl-minimal-tabs-cont align-center section-text">
                        <div class="tab-pane fade in active" id="mini-one">
                            <div class="align-center">
                                ...
                                <div>
                                    <p>After registration one ID will be provided to you. You will need that ID to issue your bill </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="align-center">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="clearfix">
                                            <form class=" form contact-form" id="contact_form" method="post" action="{{route('customer.store')}}" enctype="multipart/form-data">
                                            @csrf
                                            <!-- Name -->
